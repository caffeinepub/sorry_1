...
function App() {
  ...
  const [fadeClass, setFadeClass] = reactExports.useState("question-fade-in");
  const [showFinal, setShowFinal] = reactExports.useState(false);
  const [noHovered, setNoHovered] = reactExports.useState(false);
  const [floatingHearts, setFloatingHearts] = reactExports.useState([]);
  const heartIdRef = reactExports.useRef(0);
  reactExports.useEffect(() => {
    if (!showFinal) return;
  ...
  const gradientBg = "radial-gradient(ellipse at center, #f5dede 0%, #e8a0a4 38%, #a83a3e 100%)";
  if (showFinal) {
              ...
              children: [
                /* @__PURE__ */ jsxRuntimeExports.jsx(
                  "div",
                  {
                    style: {
                      color: "#f7f1f1",
                      textShadow: "0 2px 16px rgba(100,20,30,0.5), 0 1px 4px rgba(0,0,0,0.3)",
                ...
                /* @__PURE__ */ jsxRuntimeExports.jsx(
                  "div",
                  {
                    ...
                    children: "jyada nautanki na kario"
                  }
                ),
                /* @__PURE__ */ jsxRuntimeExports.jsx("div", { style: { marginTop: "2.5rem", fontSize: "2.5rem" }, children: "🌹" })
              ]
            }
          )
        ]
        ...
        /* @__PURE__ */ jsxRuntimeExports.jsx(
          "div",
          {
            style: {
              position: "absolute",
              inset: 0,
              background: "radial-gradient(ellipse at center, transparent 30%, rgba(100,10,20,0.22) 100%)",
              pointerEvents: "none"
            }
          }
        ),
            ...
            children: [
                  ...
                  children: /* @__PURE__ */ jsxRuntimeExports.jsx(
                    "div",
                    {
                      style: {
                        ...
                        boxShadow: "0 8px 40px rgba(120,30,40,0.35), 0 2px 12px rgba(0,0,0,0.2)",
                        overflow: "hidden",
              ...
              /* @__PURE__ */ jsxRuntimeExports.jsxs(
                "div",
                {
                  ...
                  children: [
                    /* @__PURE__ */ jsxRuntimeExports.jsx("div", { style: { display: "flex", gap: "10px" }, children: QUESTIONS.map((q, i) => /* @__PURE__ */ jsxRuntimeExports.jsx(
                      "div",
                      {
                        style: {
                          ...
                          height: "10px",
                          borderRadius: "5px",
                          background: i === currentQuestion ? "rgba(247,241,241,0.95)" : i < currentQuestion ? "rgba(247,241,241,0.6)" : "rgba(247,241,241,0.25)",
                    ...
                    /* @__PURE__ */ jsxRuntimeExports.jsxs(
                      "div",
                      {
                        ...
                        style: {
                          ...
                          lineHeight: 1.55,
                          color: "#f7f1f1",
                          textShadow: "0 2px 18px rgba(100,15,25,0.45), 0 1px 4px rgba(0,0,0,0.25)",
                          maxWidth: "580px"
                        },
                        children: [
                          "“",
                          ...
                          /* @__PURE__ */ jsxRuntimeExports.jsx(
                            "button",
                            {
                              ...
                              style: {
                                ...
                                cursor: "pointer",
                                boxShadow: noHovered ? "0 0 50px rgba(200,60,90,0.80), 0 6px 30px rgba(0,0,0,0.25)" : "0 0 24px rgba(185,60,85,0.55), 0 4px 18px rgba(0,0,0,0.2)",
                                transform: noHovered ? "scale(1.28)" : "scale(1)",
                                transition: "transform 0.35s cubic-bezier(0.34,1.56,0.64,1), padding 0.35s ease, font-size 0.35s ease, box-shadow 0.35s ease",
                                zIndex: 2,
                                position: "relative"
                              },
                              children: "YES ❤️"
                          ...
                          /* @__PURE__ */ jsxRuntimeExports.jsx(
                            "button",
                            {
                              ...
                              style: {
                                ...
                                transform: noHovered ? "scale(0.68) translateX(18px)" : "scale(1) translateX(0)",
